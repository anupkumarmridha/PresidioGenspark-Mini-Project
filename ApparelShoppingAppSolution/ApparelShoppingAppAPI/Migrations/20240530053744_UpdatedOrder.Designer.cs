...
namespace ApparelShoppingAppAPI.Migrations
{
    ...
    [Migration("20240530053744_UpdatedOrder")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ApparelShoppingAppAPI.Models.DB_Models.Review", b =>
                {
                    b.HasOne("ApparelShoppingAppAPI.Models.DB_Models.Customer", null)
                        .WithMany("Reviews")
                        .HasForeignKey("CustomerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ApparelShoppingAppAPI.Models.DB_Models.Product", null)
                        .WithMany("Reviews")
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
